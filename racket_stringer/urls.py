...
urlpatterns = [
    ...
    path(
        'racket_stringer/my_orders',
        views.MyOrders.as_view(),
        name='my_orders'
    ),
    path(
        'racket_stringer/new_order',
        views.NewOrder.as_view(),
        name='new_order'
    ),
    path(
    ...
    path(
        'racket_stringer/new_customer',
        views.NewCustomer.as_view(),
        name='new_customer'
    ),
    path(
    ...
    path(
        'racket_stringer/search_strings',
        views.search_strings,
        name='search_strings'
    ),
]
